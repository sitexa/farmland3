    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
            <div class="box">
                ...
                <div class="content">
                    <s:form theme="simple" id="frmPost" name="frmPost" action="%{#request.contextPath}/post/farm-post">
                        <s:hidden id="_method" name="_method"/>
                        <s:hidden name="site.siteId"/>
                        <s:hidden name="farm.farmId"/>
                        <s:hidden name="post.id"/>
                        农庄:<s:property value="farm.farmName"/>
                        ...
                        <s:submit cssClass="button" value="提交"/>
