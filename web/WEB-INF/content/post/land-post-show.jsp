    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
            <div class="box">
                ...
                <div class="infobox">
                    ...
                    <s:if test="post.creator.memberId==profile.memberId||site.governor.memberId==profile.memberId">
                        <a href="<%=request.getContextPath()%>/post/land-post/${post.id}/edit">编辑</a>
                        <a href="<%=request.getContextPath()%>/post/land-post/${post.id}/destroy">删除</a>
                    </s:if>
                </div>
            </div>
                        ...
                        <div class="box">
                            <div class="infobox">
                                ...
                                <s:if test="creator.memberId==profile.memberId||post.creator.memberId==profile.memberId||site.governor.memberId==profile.memberId">
                                    <a href="<%=request.getContextPath()%>/post/land-post/${id}/destroy">删除</a>
                                </s:if>
                            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    <s:form theme="simple" action="%{#request.contextPath}/post/land-post/%{post.id}/comment">
