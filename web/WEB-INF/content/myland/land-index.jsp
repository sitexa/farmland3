...
<div id="container">
    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
            <div class="t">
                <div class="t-t">
                    <div class="t-m"><a href="<%=request.getContextPath()%>/myland/land/new">创建农场</a></div>
                    农场管理
                </div>
            </div>
            <div class="box">
                <table border="0" cellpadding="2" cellspacing="4" width="100%">
                    ...
                    <s:iterator value="lands" status="its">
                        <tr class='<s:if test="#its.even">even</s:if><s:else>odd</s:else>'>
                            ...
                            <td>${landLord}</td>
                            <td>
                                <a href="<%=request.getContextPath()%>/myland/land/${landId}">预览</a>
                                <a href="<%=request.getContextPath()%>/myland/land/${landId}/edit">修改</a>
                                <a href="<%=request.getContextPath()%>/myland/land/${landId}/destroy">删除</a>
                            </td>
                        </tr>
                    </s:iterator>
                </table>
