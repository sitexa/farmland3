                ...
                <table cellspacing="2">
                    ...
                    <s:iterator value="services" status="its">
                        <tr class='<s:if test="#its.even">even</s:if><s:else>odd</s:else>'>
                            ...
                            <td>${contents}</td>
                            <td>
                                <a href="<%=request.getContextPath()%>/myland/service/${svcId}/show">浏览</a>
                                <a href="<%=request.getContextPath()%>/myland/service/${svcId}/edit">编辑</a>
                                <a href="<%=request.getContextPath()%>/myland/service/${svcId}/destroy">删除</a>
                            </td>
                        </tr>
                    </s:iterator>
                </table>
