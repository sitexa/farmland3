		...
		$(function(){
			$("#actionId").change(function(){
				...
				if(svcId==0){
					...
					$.getJSON(
						"<%=request.getContextPath()%>/myland/faction!getServiceData",
						{svcId:svcId},
						function(data){
							fillValue(data);
							$("#imgName").val("");
...
<div id="container">
    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
            ...
            <div class="box">
                <div class="box">
                    <s:form id="frmFaction" action="%{#request.contextPath}/myland/faction" method="post">
                        ...
                        <table border="0" width="100%">
                            ...
                            <tr>
                                <td>选择模板:</td>
								<td>
									<s:select id="actionId" name="faction.actionId" list="services" listKey="svcId" listValue="svcName" headerKey="0" headerValue="--空模板--"/>
								</td>
