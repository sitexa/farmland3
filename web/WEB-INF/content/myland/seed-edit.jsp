    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
			<div class="box">
                ...
                <div class="contents">
					<s:form id="frmFaction" action="%{#request.contextPath}/myland/seed" method="post">
						...
						<table>
							<tr>
								<td>
									...
									<span class="blank6"></span>
									种子名称：<s:textfield name="seed.seedName"/>
									<span class="blank6"></span>
									种子价格：<s:textfield name="seed.price"/>
									<span class="blank6"></span>
									种植说明：<br />
								</td>
							...
							<tr>
								<td colspan="2">
									<s:textarea name="seed.description" cols="60" rows="4"/>
								</td>
							</tr>
							<tr>
