    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
			<div class="box">
                ...
                <div class="contents">
					<s:form id="frmSeed" action="%{#request.contextPath}/myland/seed" method="post">
						<input type="hidden" name="landId" value="${land.landId }" />
						<input type="hidden" id="imgName" name="imgName"/>
						<table>
							<tr>
								<td>
									所属农场：<s:property value="land.landName"/> <br>
									种子名称：<s:textfield name="seed.seedName"/><br>
									种子价格：<s:textfield name="seed.price"/> <br>
									种植说明：<br/>
								</td>
							...
							<tr>
								<td colspan="2">
									<s:textarea name="seed.description" cssStyle="width:560px"/>
								</td>
							</tr>
							<tr>
                                <td>状态：<s:textfield id="status" name="seed.status"/></td>
								<td>
									<s:submit value="保 存" method="create" cssClass="formbutton"/>
								</td>
							</tr>
						</table>
					</s:form>
