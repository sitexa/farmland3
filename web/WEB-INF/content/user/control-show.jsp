                ...
                <div class="content">
                    <s:if test="pictures.size>0">
                        ...
                        <div class="box">
                            <script>
                                if (photos.length > 0)
                                    document.write('<img src="' + photos[0] + '" id="photoslider" name="photoslider" onclick="forward()" style="filter:revealTrans(duration=2,transition=23);overflow:hide" border=0>');
                            </script>
                            <script>
                                if (photos.length > 0)
