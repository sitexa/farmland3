...
<div id="container">
    ...
    <div id="mainwrapper">
        <div id="leftbar" class="leftcol" style="border-right:1px solid gray">
        ...
        <div id="rightbar" class="rightcol" style="border-left:1px solid gray">
