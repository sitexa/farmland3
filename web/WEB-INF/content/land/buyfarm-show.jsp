        ...
        function calcValue() {
            ...
            JRentModeService.getPriceById(mode_id, function(data) {
                if (typeof(data) != "undefined") {
                    ...
                    var rent_price = parseFloat(farm_acreage) * parseFloat(data) * 12 * 10;
        ...
        <div id="centerbar">
            <div class="box">
                ...
                <div class="content" style="padding:5px">
                    <form id="buyFarm" action="<%=request.getContextPath()%>/land/buyfarm/${farm.farmId}/update" method="post">
                        所在农场：<a href="<%=request.getContextPath()%>/land/land/${land.landId}" target="_blank"><s:property value="land.landName"/></a> <br>
                        <s:hidden id="landId" name="farm.land.landId" value="%{land.landId}"/>
                        <s:hidden id="farmId" name="farm.farmId"/>
                        农庄名称：<s:textfield id="farmName" name="farm.farmName" onblur="calcValue();"/><br/>
