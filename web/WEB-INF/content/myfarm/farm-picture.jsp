...
<div id="container">
    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
            <div class="box">
                <div class="title2">管理会员图片</div>
                <div class="content">
                    <s:form theme="simple" id="frmPicture"
                            action="%{#request.contextPath}/myfarm/farm-picture/%{farm.farmId}"
                        ...
                        <table>
                            <s:iterator value="pictures">
                                <tr>
                                    <td>
                                        <s:hidden name="pictures(%{picId}).farm.farmId" value="%{farm.farmId}"/>
                                        <s:hidden name="pictures(%{picId}).picId" value="%{picId}"/>
                                        <img title="点击看大图" src="<%=request.getContextPath()%>/image?type=farm&picId=${picId}"
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td>标题</td>
                                                <td>
                                                    <s:textfield size="10" name="pictures(%{picId}).title"
                                                                 value="%{title}"/>
                                                </td>
                                            </tr>
                                            <tr>
