...
<head>
    ...
    <link href="<%=request.getContextPath()%>/myfarm/farm-manager.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="<%=request.getContextPath()%>/myfarm/farm-manager.js"></script>
