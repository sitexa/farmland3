...
<div id="container">
    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar">
            <div class="box">
                <div class="title">管理会员属性</div>
                <div class="content">
                    <s:form theme="simple" id="frmProperty"
                            action="%{#request.contextPath}/admin/user/member-property/%{member.memberId}"
                            method="post">
                        ...
                        <br/><input type=button value="增加属性" onClick="addProp();">
                        <s:submit method="update" value="保存修改"/>
                    </s:form>
                </div>
            </div>
        </div>
