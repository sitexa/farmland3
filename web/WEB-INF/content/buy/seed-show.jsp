    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
            <div class="box">
				...
				<div class="content">
				<img src="<%=request.getContextPath()%>/image?type=seed&picId=${seed.seedId }"/><br />
				<span class="blank6"></span>
				名　　称：<s:property value="seed.seedName"/><br />
				价　　格：<s:property value="seed.price"/><br />
				农事计划：<br />
				<div style="height: 100px;border: 1px #76AE2F dotted;overflow-y:auto">
					<s:property value="seed.description"/><br />
				</div>
