        ...
        <div id="centerbar" class="centercol">
            ...
            <div class="box">
                ...
                <div class="content">
                                    ...
                                    <li id="${farmId}">
                                        <s:if test="member!=null">
                                            <a class="link2" href="<%=request.getContextPath()%>/myfarm/myfarm/${farmId}">
                                           	...
                                           	农庄面积:${acreage}平方米&nbsp;
                                       	 	农庄主:<a class="link2" href="<%=request.getContextPath()%>/user/member/${member.memberId}">${member.realname}</a>
                                        </s:if>
                    ...
                    <form id="frmSearch" style="display:none;" action="<%=request.getContextPath()%>/buy/farm!enterFarms" onsubmit="dos(1);"
                          method="get">
