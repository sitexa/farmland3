...
<div id="container">
    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
                ...
                <table>
                    ...
                    <s:iterator value="seeds" status="its">
                        <tr class='<s:if test="#its.even">even</s:if><s:else>odd</s:else>'>
                            ...
                            <td>${status}</td>
                            <td>
                                <a href="<%=request.getContextPath()%>/join/seed/${seedId}/edit?page.current=${page.current }">修改</a>
                                <a href="<%=request.getContextPath()%>/join/seed/${seedId}/destroy?page.current=${page.current }">删除</a>
                            </td>
                        </tr>
                    </s:iterator>
                </table>
            ...
            <form id="frmSearch" style="display:none;" action="<%=request.getContextPath()%>/join/seed"
                 method="get">
