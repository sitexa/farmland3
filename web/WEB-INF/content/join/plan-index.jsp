...
<div id="container">
    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
                ...
                <table width="100%">
                    ...
                    <s:iterator value="farmPlans" status="its">
                        <tr class='<s:if test="#its.even">even</s:if><s:else>odd</s:else>'>
                            ...
                            <td>${description}</td>
                            <td>
                                <a href="<%=request.getContextPath()%>/join/plan/${planId}/edit?page.current=${page.current }">修改</a>
                                <a href="<%=request.getContextPath()%>/join/plan/${planId}/destroy?page.current=${page.current }">删除</a>
                            </td>
                        </tr>
                    </s:iterator>
                </table>
            ...
            <form id="frmSearch" style="display:none;" action="<%=request.getContextPath()%>/join/plan"
                  onsubmit="dos(1);" method="get">
				<s:hidden name="landId" value="%{#request.land.landId}"></s:hidden>
