                ...
                <table width="100%" border="0" cellspacing="2">
                    ...
                    <s:iterator value="farms" status="its">
                        <tr class='<s:if test="#its.even">even</s:if><s:else>odd</s:else>'>
                            ...
                            <td align="right">
                                <a href="<%=request.getContextPath()%>/join/farm/${farmId}">查看</a>
                                <a href="<%=request.getContextPath()%>/join/farm/${farmId}/edit">修改</a>
                                <a href="<%=request.getContextPath()%>/join/farm/${farmId}/destroy">删除</a>
                            </td>
                        </tr>
                    </s:iterator>
                </table>
