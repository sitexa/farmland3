    ...
    <div id="mainwrapper">
        ...
        <div id="centerbar" class="centercol">
            <div class="box">
                ...
                <div class="content">
                    <div class="map" style="float:right"><s:include value="../map.jsp"/></div>
					...
					纬　　度：<s:property value="site.latitude"/><br/>
					经　　度：<s:property value="site.longitude"/><br/>
                ...
                <s:if test="home==null||home.siteId!=site.siteId">
                    <div style="padding-left:10px;text-decoration:underline;color:red;">
                        <a id="add" onclick="applyFriend();">加为友好社区</a>
                    </div>
                    <div id="addFriend" class="content" style="display:none;">
                        <s:form action="%{#request.contextPath}/site/site-member/%{site.siteId}/apply" theme="simple">
                           	申请理由:<br/>
