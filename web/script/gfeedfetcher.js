...
gfeedfetcher._formatdate = function(datestr, showoptions) {
    ...
    var parseddate = (showoptions.indexOf("datetime") != -1) ? itemdate.format("yyyy-MM-dd hh:mm") : (showoptions.indexOf("date") != -1) ? itemdate.format("yyyy-MM-dd") : (showoptions.indexOf("time") != -1) ? itemdate.format("hh:mm:sss") : ""
