 ...
 * Time: 17:44:06
 */
public class LogonController extends LoginAction {

    private static Log log = LogFactory.getLog(LogonController.class);
...
//                    return show();
    ...
    public HttpHeaders setEmail() {
        return new DefaultHttpHeaders("setEmail").disableCaching();
    }

    public HttpHeaders sendActivateEmail() {
        ...
        return new DefaultHttpHeaders("sendActivateEmail").disableCaching();
    }

    public HttpHeaders activate() {
        String userId = ServletActionContext.getRequest().getParameter("userId");
        String code = ServletActionContext.getRequest().getParameter("code");
        user = UserService.activate(userId, code);
