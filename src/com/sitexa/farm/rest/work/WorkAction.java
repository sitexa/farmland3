...
public class WorkAction extends FarmlanderAction {
    ...
    protected List<Faction> factions = new ArrayList<com.sitexa.farm.data.Faction>();
    ...
    protected List<Post> newPicks = new ArrayList<Post>();

    protected String creditPassword;

    protected Page page = new Page(30);
    ...
    public MemberCredit getCredit() {
        return credit;
    }

    public void setCredit(MemberCredit credit) {
        this.credit = credit;
    }

    public List<Post> getNewPicks() {
        return newPicks;
    }

    public void setNewPicks(List<Post> newPicks) {
