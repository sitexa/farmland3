...
public class RoleInUserId implements java.io.Serializable {
     ...
     * full constructor
     */
    public RoleInUserId(User user, Role role) {
        this.user = user;
        this.role = role;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof RoleInUserId))
            return false;
        RoleInUserId castOther = (RoleInUserId) other;
