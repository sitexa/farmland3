 ...
 * @see com.sitexa.market.data.OrderStatus
 */
...
public class OrderStatusDAO extends BaseDAO {
    ...
    public OrderStatus findById(java.lang.String id) {
        log.debug("getting OrderStatus instance with id: " + id);
        try {
            OrderStatus instance = (OrderStatus) getSession().get(
                    "com.sitexa.market.data.OrderStatus", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(OrderStatus instance) {
        ...
        try {
            List results = getSession().createCriteria(
                    "com.sitexa.market.data.OrderStatus").add(
    ...
    public List findByOrderStatusName(Object orderStatusName) {
        return findByProperty(ORDER_STATUS_NAME, orderStatusName);
    }
    ...
    public OrderStatus merge(OrderStatus detachedInstance) {
        ...
        try {
            OrderStatus result = (OrderStatus) getSession().merge(
                    detachedInstance);
